...
public final class PaymentModeSaleInterfaceEdited {
	...
	public PaymentModeSaleInterfaceEdited(){
		throw new UnsupportedOperationException("#PaymentModeSaleInterfaceEdited()");
	}
	
	@JsonCreator
	public PaymentModeSaleInterfaceEdited( @JsonProperty("id") final UUID id,
